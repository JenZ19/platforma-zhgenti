...
const profiles: Record<OriginalQuestSlug, QuestCustomizationProfile> = {
  ...
  "unique-design": {
    slug: "unique-design",
    title: "Соберите свой визуальный характер",
    promise: "Выберите тип проекта, аудиторию и характер. Затем три разных референса дадут структуру, настроение и одну фирменную деталь — Codex соединит их с вашим содержанием.",
    preview: { caption: "Три референса — одна своя система", metric: "3 роли", action: "Собрать концепт" },
    axes: {
      audience: { label: "Для кого вы делаете проект", hint: "Можно начать со своего проекта, а в конце повторить тот же метод для заказчика.", options: ["Для своего проекта", "Для эксперта-заказчика", "Для семейного сервиса", "Для небольшого бизнеса"] },
      goal: { label: "Что именно проект должен сделать", hint: "Выберите один главный результат: показать услугу, привести к заявке или помочь выполнить действие.", options: ["Лендинг ведёт к заявке", "Сервис помогает выполнить одно действие", "Сайт объясняет и вызывает доверие", "Портфолио показывает работу"] },
      name: { label: "Как называется ваша версия", hint: "Используйте своё подтверждённое название или безопасное учебное.", options: ["Моя студия", "Тихий запуск", "Свой ритм", "Проект с характером"] },
      style: { label: "Какое настроение будет у проекта", hint: "Это не готовый шаблон: Codex превратит выбранное настроение в правила цвета, шрифта, ритма и формы.", options: ["Тактильный альбом", "Графический журнал", "Спокойная мастерская", "Смелая геометрия"] },
      tone: { label: "Как проект разговаривает", hint: "Тон влияет на заголовки, кнопки, подсказки и ошибки.", options: ["Тепло и по-человечески", "Редакционно и уверенно", "Коротко и спокойно", "Смело, но без давления"] },
      feature: { label: "Какая одна деталь станет вашей", hint: "Берём принцип, а не копию: Codex перерисует деталь под ваше содержание и стиль.", options: ["Навигация как цветные ярлыки", "Карточки как листы альбома", "Необычная рамка вокруг главного действия", "Фирменные подписи на полях"] },
    },
  },
};
  ...
  return {
    ...
    axes: {
      ...
      style: {
        ...
        options: project.kind === "agent" ? ["Чат как переписка", "Карточка результата", "Спокойная рабочая панель"]
          : project.kind.includes("site") || project.kind === "portfolio" ? ["Чистая страница с крупными фотографиями", "Выразительная типографика", "Тёплый личный сайт", "Деловая страница без лишнего"]
          : ["Список и крупные кнопки", "Карточки по категориям", "Спокойная рабочая панель"],
      },
      tone: {
