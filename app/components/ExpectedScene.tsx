...
function Visual({ project, step }: { project: ProjectDefinition; step: number }) {
  if (["family-expenses", "planner", "idea-vault"].includes(project.slug)) return <OriginalServiceScene slug={project.slug} step={step} />;
