...
console.log(`Проверено ${count} WebP-экранов: ${generalCount} общих, ${homeHelperCount} подробных home-helper и ${originalGuideCount} кадров одиннадцати подробных квестов, все 600x400.`);
